...
$outputFile = "C:\UA3\source\mms-cms-util\components\SQATools\Coverity\HSP_UA3_Main(Dev)\Main.CoverityScanList.txt"
...
$modules = "mms-cms-adm", "mms-cms-core", "mms-cms-cfg", "mms-cms-dr", "mms-cms-edi", "mms-cms-fxfer", 
            ...
            "mms-cms-fm", "mms-cms-authdeter", "mms-cms-cef", "mms-cms-fm", "mms-cms-meddent", 
            "mms-cms-paae", "mms-cms"
