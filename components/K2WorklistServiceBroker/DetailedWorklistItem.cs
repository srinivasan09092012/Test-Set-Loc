...
namespace SourceCode.SmartObjects.Services.WorklistService
{
    public class DetailedWorklistItem : BasicWorklistItem
    {
        ...
        internal override ServiceSDK.Objects.Properties DescribeProperties()
        {
            ...
            props.Create(new Property("ActivityDescription", "System.String", SoType.Text, new MetaData("Activity Description", "Activity Description")));
            props.Create(new Property("ActivityMetaData", "System.String", SoType.Text, new MetaData("Activity MetaData", "Activity MetaData")));
            props.Create(new Property("ActivityExpectedDuration", "System.Int32", SoType.Number, new MetaData("Activity Expected Duration", "Activity Expected Duration")));

            // additional process instance properties
            props.Create(new Property("ProcessDescription", "System.String", SoType.Text, new MetaData("Process Description", "Process Description")));
            props.Create(new Property("ProcessMetaData", "System.String", SoType.Text, new MetaData("Process MetaData", "Process Meta Data")));
            props.Create(new Property("ProcessExpectedDuration", "System.Int32", SoType.Number, new MetaData("Process Expected Duration", "Process Expected Duration")));
            props.Create(new Property("ProcessPriority", "System.String", SoType.Text, new MetaData("Process Priority", "Process Priority")));
            props.Create(new Property("ProcessInstanceStartDate", "System.DateTime", SoType.DateTime, new MetaData("Process Instance Start Date", "Process Instance Start Date")));
